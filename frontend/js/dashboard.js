...
/* BACKEND */
let emissions=await fetch("http://https://green-commute-uib8.onrender.com/api/emission",{
method:"POST",
headers:{"Content-Type":"application/json"},
body:JSON.stringify({distance:distanceKm})
}).then(r=>r.json());

let costs=await fetch("http://https://green-commute-uib8.onrender.com/api/cost",{
method:"POST",
headers:{"Content-Type":"application/json"},
body:JSON.stringify({distance:distanceKm})
}).then(r=>r.json());
...
fetch("http://https://green-commute-uib8.onrender.com/api/save-trip",{
method:"POST",
headers:{
...
let res=await fetch("http://https://green-commute-uib8.onrender.com/api/trips",{
